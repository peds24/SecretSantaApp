...
export type WishlistWhereInput = {
  ...
  receiverId?: Prisma.IntFilter<"Wishlist"> | number
  wishlist?: Prisma.StringFilter<"Wishlist"> | string
}
...
export type WishlistScalarWhereWithAggregatesInput = {
  ...
  receiverId?: Prisma.IntWithAggregatesFilter<"Wishlist"> | number
  wishlist?: Prisma.StringWithAggregatesFilter<"Wishlist"> | string
}
...
export type WishlistOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"receiverId" | "wishlist", ExtArgs["result"]["wishlist"]>
...
export interface WishlistDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const wishlistWithReceiverIdOnly = await prisma.wishlist.findMany({ select: { receiverId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Wishlists and only return the `receiverId`
   * const wishlistWithReceiverIdOnly = await prisma.wishlist.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Wishlists and only return the `receiverId`
   * const wishlistWithReceiverIdOnly = await prisma.wishlist.updateManyAndReturn({
   *   select: { receiverId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface WishlistFieldRefs {
  readonly receiverId: Prisma.FieldRef<"Wishlist", 'Int'>
  readonly wishlist: Prisma.FieldRef<"Wishlist", 'String'>
}
